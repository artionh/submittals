...
public class EmailServiceImpl implements EmailService {
	...
	public ServiceResponse<List<Email>> getEmails() {
		...
		if (emailList.isEmpty()) {
			serviceMessageList.add(new ServiceMessage("200", "No Email were found", ProblemSeverity.INFO));
		} else {
			serviceMessageList
					.add(new ServiceMessage("200", "This service return a list of emails", ProblemSeverity.INFO));
		}
